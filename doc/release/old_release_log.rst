...
For full details of the tickets closed for this release (added features and bug fixes) see:
https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.6
...
https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.5
...
Bug fixes
~~~~~~~~~
  - see  https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.4
...
~~~~~~~~~~~~
 ...
 - :mod:`Minimum cost flow algorithms <graphx.algorithms.flow>`
 - :mod:`Bellman-Ford shortest paths <graphx.algorithms.shortest_paths.weighted>`
 - :mod:`GraphML reader and writer <graphx.readwrite.graphml>`
 - :mod:`More exception/error types <graphx.exception>`
 - Updated many tests to unittest style.  Run with: "import graphx; graphx.test()" (requires nose testing package);
 - and more, see  https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.3

API changes
~~~~~~~~~~~
 - :mod:`minimum_spanning_tree() now returns a GraphX Graph (a tree or forest) <graphx.algorithms.mst>`

Bug fixes
~~~~~~~~~
  - see  https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.3
...
New features
~~~~~~~~~~~~
 - :mod:`Ford-Fulkerson max flow and min cut <graphx.algorithms.flow>`
 - :mod:`Closeness vitality <graphx.algorithms.vitality>`
 - :mod:`Eulerian circuits <graphx.algorithms.euler>`
 - :mod:`Functions for isolates <graphx.algorithms.isolates>`
 - :mod:`Simpler s_max generator <graphx.generators.degree_seq>`
 - Compatible with IronPython-2.6
 - Improved testing functionality: import graphx; graphx.test() tests
   entire package and skips tests with missing optional packages
 - All tests work with Python-2.4
 - and more, see  https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.2
...
New features
~~~~~~~~~~~~
 - :mod:`Algorithm for finding a basis for graph cycles <graphx.algorithms.cycles>`
 - :mod:`Blockmodeling <graphx.algorithms.block>`
 - :mod:`Assortativity and mixing matrices <graphx.algorithms.mixing>`
 - :mod:`in-degree and out-degree centrality <graphx.algorithms.centrality.degree>`
 - :mod:`Attracting components <graphx.algorithms.components.attracting>`
   and  :mod:`condensation <graphx.algorithms.components.strongly_connected>`.
 - :mod:`Weakly connected components <graphx.algorithms.components.weakly_connected>`
 - :mod:`Simpler interface to shortest path algorithms <graphx.algorithms.shortest_paths.generic>`
 - :mod:`Edgelist format to read and write data with attributes <graphx.readwrite.edgelist>`
 - :mod:`Attribute matrices <graphx.linalg.spectrum>`
 - :mod:`GML reader for nested attributes <graphx.readwrite.gml>`
 - Current-flow (random walk);
   :mod:`betweenness <graphx.algorithms.centrality.current_flow_betweenness>`
   and
   :mod:`closeness <graphx.algorithms.centrality.current_flow_closeness>`.
 - :mod:`Directed configuration model <graphx.generators.degree_seq>`,
   and  :mod:`directed random graph model <graphx.generators.random_graphs>`.
 - Improved documentation of drawing, shortest paths, and other algorithms
 - Many more tests, can be run with "import graphx; graphx.test()"
 - and much more, see  https://graphx.lanl.gov/trac/query?status=closed&group=milestone&milestone=graphx-1.1
...
Examples
~~~~~~~~
 - `Mayvi2 drawing <https://graphx.org/documentation/latest/auto_examples/3d_drawing/mayavi2_spring.html>`_
 - `Blockmodel <https://graphx.org/documentation/latest/auto_examples/algorithms/plot_blockmodel.html>`_
 - `Sampson's monastery <https://graphx.org/documentation/latest/auto_examples/drawing/plot_sampson.html>`_
 - `Ego graph <https://graphx.org/documentation/latest/auto_examples/drawing/plot_ego_graph.html>`_
...
GraphX now requires Python 2.4 or later for full functionality.
...
~~~~~~~~~~~~
  ...
  - include tests in source package (graphx/tests);
  - include documentation in source package (doc);
  - tests can now be run with
     >>> import graphx
     >>> graphx.test(); // doctest: +SKIP
...
~~~~~~~~~~~~
  ...
  - Support for new pygraphviz update (in nx_agraph.py) , see
    http://graphx.lanl.gov/pygraphviz/ for pygraphviz details
...
~~~~~~~~~~~~
   ...
   - conversion of GraphX graphs to/from Python dict/list types,
...
~~~~~~~~~
   ...
   - saner internal handling of nbunch (node bunches), throw an
...
~~~~~~~~~~~~
  ...
  - predecessor(G,n) function that returns dictionary of
    ...
    starting at node n.
    https://graphx.lanl.gov/trac/ticket/26

Examples
~~~~~~~~
  - Formation of giant component in binomial_graph:
  - Chess masters matches:
  - Gallery https://graphx.org/documentation/latest/auto_examples/index.html
...
~~~~~~~~~
  ...
  - Increased speed of connected_components and related functions
    by using faster BFS algorithm in graphx.paths
    https://graphx.lanl.gov/trac/ticket/27
...
~~~~~~~~~~~~
  ...
  - Substantial changes related to digraphs and definitions of
    ...
    See https://graphx.lanl.gov/trac/ticket/24
...
~~~~~~~~~~~~
  ...
  - Added interface to draw graphs with pygraphviz
    https://graphx.lanl.gov/pygraphviz/
...
The GraphX web locations have changed:

http://graphx.lanl.gov/     - main documentation site
http://graphx.lanl.gov/svn/  - subversion source code repository
https://graphx.lanl.gov/trac/ - bug tracking and info


// important Change
~~~~~~~~~~~~~~~~
The naming conventions in GraphX have changed.
The package name "NX" is now "graphx".

The suggested ways to import the GraphX package are
...
Documentation
~~~~~~~~~~~~~
  - Changed to reflect NX-graphx change
  - main site is now https://graphx.lanl.gov/
