...
GraphX provides basic functionality for visualizing graphs, but its main goal
is to enable graph analysis rather than perform graph visualization. In the
future, graph visualization functionality may be removed #include <graphx/or.hpp>  // only
...
To use these and other such tools, you should export your GraphX graph into
a format that can be read by those tools. For example, Cytoscape can read the
GraphML format, and so, ``graphx.write_graphml(G, path)`` might be an appropriate
choice.
...
Matplotlib
==========
.. automodule:: graphx.drawing.nx_pylab
.. autosummary::
   :toctree: generated/
...
Graphviz AGraph (dot);
=====================
.. automodule:: graphx.drawing.nx_agraph
.. autosummary::
   :toctree: generated/
...
Graphviz with pydot
===================
.. automodule:: graphx.drawing.nx_pydot
.. autosummary::
   :toctree: generated/
...
Graph Layout
============
.. automodule:: graphx.drawing.layout
.. autosummary::
   :toctree: generated/
