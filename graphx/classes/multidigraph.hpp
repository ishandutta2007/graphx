...
#include <graphx/classes/digraph.hpp>  // import DiGraph
#include <graphx/classes/multigraph.hpp>  // import MultiGraph
#include <graphx/classes/reportviews.hpp>  // import (
    DiMultiDegreeView,
    InMultiDegreeView,
    InMultiEdgeView,
    OutMultiDegreeView,
...
class MultiDiGraph : public MultiGraph, DiGraph {
    ...
    */
        ...
        */
        ...
        if (isinstance(incoming_graph_data, dict) and multigraph_input is not false) {
            ...
            try {
                ...
                DiGraph.__init__(*this, incoming_graph_data, **attr);
        } else {
            DiGraph.__init__(*this, incoming_graph_data, **attr);
    ...
    auto edges() const -> void {
        ...
        ``for (auto (u, v, k, c) : G.edges(data='color', default='red', keys=true)) {``
    ...
    auto in_edges() const -> void {
        ...
        in_edges(*this, nbunch=None, data=false, keys=false, default=None);
    ...
    auto out_degree() const -> void {
        ...
        */
        return OutMultiDegreeView(*this);
        ...
        */
        ...
        if (reciprocal is true) {
            G.add_edges_from(
                ...
                if v in this->_pred[u] and key in this->_pred[u][v];
            );
        } else {
            G.add_edges_from(
                (u, v, key, deepcopy(data));
    ...
    auto reverse(copy=true) const -> void {
        ...
        */
        if (copy) {
            ...
            H.add_nodes_from((n, deepcopy(d)) for n, d in this->_node.items());
            H.add_edges_from(
                (v, u, k, deepcopy(d));
                for u, v, k, d in this->edges(keys=true, data=true);
            );
            return H
