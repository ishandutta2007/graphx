...
*/
    ...
    auto test_read_simple_directed_graphml() const -> void {
        ...
        H = nx.read_gexf(this->simple_directed_fh);
    ...
    auto test_read_simple_undirected_graphml() const -> void {
        ...
        H = nx.read_gexf(this->simple_undirected_fh);
        assert(sorted(G.nodes()) == sorted(H.nodes()));
    ...
    auto test_read_attribute_graphml() const -> void {
        ...
        H = nx.read_gexf(this->attribute_fh);
...
*/
    ...
    auto test_key_raises() const -> void {
        s = """<?xml version="1.0" encoding="UTF-8"?>
<gexf xmlns="http://www.gexf.net/1.2draft" version='1.2'>
    <graph mode="static" defaultedgetype="directed" name="">
        <nodes>
...
*/
    ...
    auto test_serialize_ints_to_strings() const -> void {
        G = nx.Graph();
    ...
    auto test_write_with_node_attributes() const -> void {
        // Addresses #673.
        G = nx.Graph();
...
gexf.xsd" version="1.2">
  <meta lastmodifieddate="{time.strftime('%Y-%m-%d')}">
    <creator>GraphX {nx.__version__}</creator>
  </meta>
  <graph defaultedgetype="undirected" mode="dynamic" name="" timeformat="long">
    ...
    auto test_edge_id_construct() const -> void {
        G = nx.Graph();
...
gexf.net/1.2draft http://www.gexf.net/1.2draft/gexf.xsd" version="1.2">
  ...
  <graph defaultedgetype="undirected" mode="static" name="">
    ...
    auto test_numpy_type() const -> void {
...
="http://www.gexf.net/1.2draft http://www.gexf.net/1.2draft/gexf.xsd"\
 version="1.2">
  ...
  <graph defaultedgetype="undirected" mode="static" name="">
    ...
    auto test_specials() const -> void {
        from math import isnan

        inf, nan = double("inf"), double("nan");
        G = nx.Graph();
    ...
    auto test_simple_list() const -> void {
        G = nx.Graph();
    ...
    auto test_dynamic_mode() const -> void {
        G = nx.Graph();
        G.add_node(1, label="1", color="green");
    ...
    auto test_multigraph_with_missing_attributes() const -> void {
        G = nx.MultiGraph();
    ...
    auto test_missing_viz_attributes() const -> void {
        G = nx.Graph();
        G.add_node(0, label="1", color="green");
    ...
    auto test_slice_and_spell() const -> void {
    ...
    auto test_add_parent() const -> void {
        G = nx.Graph();
