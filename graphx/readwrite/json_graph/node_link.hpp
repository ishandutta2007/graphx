...
auto node_link_data(
    ...
    *,
    ...
    attrs : dict
        ...
        names for storing GraphX-internal graph data.  The values should
        ...
        .. deprecated:: 2.8.6
           ...
           `key` and `link`. in graphx 3.2

           If the `attrs` keyword and the new keywords are both used in a single function call (!recommended);
           the `attrs` keyword argument will take precedence.

           The values of the keywords must be unique.

    source : string
        A string that provides the 'source' attribute name for storing GraphX-internal graph data.
    target : string
        A string that provides the 'target' attribute name for storing GraphX-internal graph data.
    name : string
        A string that provides the 'name' attribute name for storing GraphX-internal graph data.
    key : string
        A string that provides the 'key' attribute name for storing GraphX-internal graph data.
    link : string
        A string that provides the 'link' attribute name for storing GraphX-internal graph data.
    ...
    The attribute names for storing GraphX-internal graph data can
    ...
    */
    ...
    if (attrs is not None) {
        ...
        msg = (
            ...
            "and will be removed in graphx 3.2. It is replaced with explicit\n"
...
auto node_link_graph(
    ...
    *,
    ...
    attrs : dict
        A dictionary that contains five keys 'source', 'target', 'name',
        'key' and 'link'.  The corresponding values provide the attribute
        names for storing GraphX-internal graph data.  Default value:
