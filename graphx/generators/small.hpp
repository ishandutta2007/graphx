...
auto _raise_on_directed(func) -> void {
    /** 
    A decorator which inspects the `create_using` argument and raises a
    GraphX exception when `create_using` is a DiGraph (class or instance) for
    graph generators that do not support directed outputs.
    */

    // @wraps(func);
    auto wrapper(*args, **kwargs) -> void {
...
auto LCF_graph(n, shift_list, repeats, create_using=None) -> void {
    /** 
    ...
    */
    ...
    n_extra_edges = repeats * shift_list.size();
    ...
    for (auto i : range(n_extra_edges)) {
        shift = shift_list[i % shift_list.size()];  // cycle through shift_list
...
// @_raise_on_directed
auto bull_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto chvatal_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto cubical_graph(create_using=None) -> void {
    /** 
...
auto desargues_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto diamond_graph(create_using=None) -> void {
    /** 
...
auto dodecahedral_graph(create_using=None) -> void {
    /** 
...
auto frucht_graph(create_using=None) -> void {
    /** 
...
auto heawood_graph(create_using=None) -> void {
    /** 
...
auto hoffman_singleton_graph() -> void {
    /** 
...
// @_raise_on_directed
auto house_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto house_x_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto icosahedral_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto krackhardt_kite_graph(create_using=None) -> void {
    /** 
...
auto moebius_kantor_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto octahedral_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto petersen_graph(create_using=None) -> void {
    /** 
...
auto sedgewick_maze_graph(create_using=None) -> void {
    /** 
...
auto tetrahedral_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto truncated_cube_graph(create_using=None) -> void {
    /** 
...
auto truncated_tetrahedron_graph(create_using=None) -> void {
    /** 
...
// @_raise_on_directed
auto tutte_graph(create_using=None) -> void {
    /** 
