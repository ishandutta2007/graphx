...
#include <graphx/classes/hpp>  // import DiGraph, MultiDiGraph
...
auto stochastic_graph(G, copy=true, weight="weight") -> void {
    ...
    ----------
    G : directed graph
        A :class:`~graphx.DiGraph` or :class:`~graphx.MultiDiGraph`.
