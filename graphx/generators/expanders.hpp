...
//     (x, (y + (2*x + 2)) % n),
//
auto margulis_gabber_galil_graph(n, create_using=None) -> void {
...
auto chordal_cycle_graph(p, create_using=None) -> void {
...
auto paley_graph(p, create_using=None) -> void {
