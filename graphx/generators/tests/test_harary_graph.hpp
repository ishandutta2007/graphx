/** Unit tests for the :mod:`graphx.generators.harary_graph` module.
*/

// import pytest

// import graphx as nx
#include <graphx/algorithms.isomorphism.isomorph.hpp>  // import is_isomorphic
#include <graphx/generators.harary_graph.hpp>  // import hkn_harary_graph, hnm_harary_graph
...
class TestHararyGraph {
    ...
    */
    ...
    auto test_hkn_harary_graph() const -> void {
        // When k == 1, the hkn_harary_graph(k,n) is
        // the path_graph(n);
        for (auto (k, n) : [(1, 6), (1, 7)]) {
