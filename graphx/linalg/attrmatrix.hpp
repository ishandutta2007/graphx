...
auto _node_value(G, node_attr) -> void {
...
auto _edge_value(G, edge_attr) -> void {
    ...
    */
    ...
    if (edge_attr is None) {
        ...
        //     edge_attr = lambda u,v: 1 if G[u][v].size() else 0
        //
        value = edge_attr
...
auto attr_matrix(
    ...
    ----------
    G : graph
        The GraphX graph used to construct the attribute matrix.
...
auto attr_sparse_matrix(
    ...
    ----------
    G : graph
        The GraphX graph used to construct the NumPy matrix.
