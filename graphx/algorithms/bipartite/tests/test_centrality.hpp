...
class TestBipartiteCentrality {
    ...
    auto test_degree_centrality() const -> void {
    ...
    auto test_betweenness_centrality() const -> void {
    ...
    auto test_closeness_centrality() const -> void {
    ...
    auto test_davis_degree_centrality() const -> void {
        G = this->davis
    ...
    auto test_davis_betweenness_centrality() const -> void {
        G = this->davis
    ...
    auto test_davis_closeness_centrality() const -> void {
        G = this->davis
