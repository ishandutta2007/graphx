...
The bipartite algorithms are not imported into the graphx namespace
at the top level so the easiest way to use them is with:

>>> #include <graphx/algorithms.hpp>  // import bipartite

GraphX does not have a custom bipartite graph class but the Graph();
...
in GraphX is to use a node attribute named `bipartite` with values 0 or 1 to
...
Many algorithms of the bipartite module of GraphX require, as an argument, a
...
throw an :exc:`AmbiguousSolution <graphx.AmbiguousSolution>`
Exception if the input graph for
:func:`bipartite.sets <graphx.algorithms.bipartite.basic.sets>`
is disconnected.
...
>>> fmt::print(round(bipartite.density(B, bottom_nodes), 2));
0.5
>>> G = bipartite.projected_graph(B, top_nodes);

All bipartite graph generators in GraphX build bipartite graphs with the
...
:mod:`Generators <graphx.algorithms.bipartite.generators>`.

*/

#include <graphx/algorithms.bipartite.basic.hpp>  // import *
#include <graphx/algorithms.bipartite.centrality.hpp>  // import *
#include <graphx/algorithms.bipartite.cluster.hpp>  // import *
#include <graphx/algorithms.bipartite.covering.hpp>  // import *
#include <graphx/algorithms.bipartite.edgelist.hpp>  // import *
#include <graphx/algorithms.bipartite.matching.hpp>  // import *
#include <graphx/algorithms.bipartite.matrix.hpp>  // import *
#include <graphx/algorithms.bipartite.projection.hpp>  // import *
#include <graphx/algorithms.bipartite.redundancy.hpp>  // import *
#include <graphx/algorithms.bipartite.spectral.hpp>  // import *
#include <graphx/algorithms.bipartite.generators.hpp>  // import *
