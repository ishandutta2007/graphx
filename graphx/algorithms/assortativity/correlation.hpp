...
*/
#include <graphx/algorithms.assortativity.mixing.hpp>  // import (
    attribute_mixing_matrix,
    degree_mixing_matrix,
);
#include <graphx/algorithms.assortativity.pairs.hpp>  // import node_degree_xy
...
auto degree_assortativity_coefficient(G, x="out", y="in", weight=None, nodes=None) -> void {
...
auto degree_pearson_correlation_coefficient(G, x="out", y="in", weight=None, nodes=None) -> void {
    /** Compute degree assortativity of graph.
...
auto attribute_assortativity_coefficient(G, attribute, nodes=None) -> void {
    ...
    >>> fmt::print(nx.attribute_assortativity_coefficient(G, "color"));
    1.0
...
auto numeric_assortativity_coefficient(G, attribute, nodes=None) -> void {
    ...
    >>> G.add_edges_from([(0, 1), (2, 3)]);
    >>> fmt::print(nx.numeric_assortativity_coefficient(G, "size"));
    1.0
...
auto _numeric_ac(M, mapping) -> void {
