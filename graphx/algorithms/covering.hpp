...
auto min_edge_cover(G, matching_algorithm=None) -> void {
    ...
    matching_algorithm : function
        ...
        :func:`~graphx.algorithms.matching.max_weight_matching` is used.
        Common bipartite matching functions include
        :func:`~graphx.algorithms.bipartite.matching.hopcroft_karp_matching`
        or
        :func:`~graphx.algorithms.bipartite.matching.eppstein_matching`.
    ...
    function in :mod:`graphx.algorithms.bipartite.covering` which is
    simply this function with a default matching algorithm of
    :func:`~graphx.algorithms.bipartite.matching.hopcraft_karp_matching`
    */
    if (G.size() == 0) {
        return set();
...
// @not_implemented_for("directed");
auto is_edge_cover(G, cover) -> void {
