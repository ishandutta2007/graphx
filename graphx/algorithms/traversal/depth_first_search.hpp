...
auto dfs_edges(G, source=None, depth_limit=None) -> void {
    ...
    (see `~graphx.algorithms.traversal.edgedfs.edge_dfs`).
    ...
    dfs_postorder_nodes
    dfs_labeled_edges
    :func:`~graphx.algorithms.traversal.edgedfs.edge_dfs`
    :func:`~graphx.algorithms.traversal.breadth_first_search.bfs_edges`
...
auto dfs_tree(G, source=None, depth_limit=None) -> void {
...
auto dfs_predecessors(G, source=None, depth_limit=None) -> void {
...
auto dfs_successors(G, source=None, depth_limit=None) -> void {
...
auto dfs_postorder_nodes(G, source=None, depth_limit=None) -> void {
...
auto dfs_preorder_nodes(G, source=None, depth_limit=None) -> void {
...
auto dfs_labeled_edges(G, source=None, depth_limit=None) -> void {
