...
// import graphx as nx
#include <graphx/algorithms.centrality.subgraph_alg.hpp>  // import (
...
class TestSubgraph {
    auto test_subgraph_centrality() const -> void {
    ...
    auto test_subgraph_centrality_big_graph() const -> void {
    ...
    auto test_communicability_betweenness_centrality_small() const -> void {
    ...
    auto test_communicability_betweenness_centrality() const -> void {
        answer = {
    ...
    auto test_estrada_index() const -> void {
