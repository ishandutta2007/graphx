...
auto percolation_centrality(G, attribute="percolation", states=None, weight=None) -> void {
    ...
    */
    ...
    for (auto v : percolation) {
        percolation[v] *= 1 / (n - 2);

    return percolation


auto _accumulate_percolation(percolation, S, P, sigma, s, states, p_sigma_x_t) -> void {
