...
auto gomory_hu_tree(G, capacity="capacity", flow_func=None) -> void {
    ...
    -------
    Tree : GraphX graph
        A GraphX graph representing the Gomory-Hu tree of the input graph.
    ...
    ... // Gomory-Hu tree.
    ... auto minimum_edge_weight_in_shortest_path(T, u, v) -> void {
