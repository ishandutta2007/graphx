...
auto min_cost_flow_cost(G, demand="demand", capacity="capacity", weight="weight") -> void {
...
auto min_cost_flow(G, demand="demand", capacity="capacity", weight="weight") -> void {
...
auto cost_of_flow(G, flowDict, weight="weight") -> void {
...
auto max_flow_min_cost(G, s, t, capacity="capacity", weight="weight") -> void {
