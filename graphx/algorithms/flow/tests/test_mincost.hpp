...
class TestMinCostFlow {
    auto test_simple_digraph() const -> void {
        G = nx.DiGraph();
    ...
    auto test_negcycle_infcap() const -> void {
        G = nx.DiGraph();
    ...
    auto test_sum_demands_not_zero() const -> void {
        G = nx.DiGraph();
        G.add_node("s", demand=-5);
    ...
    auto test_no_flow_satisfying_demands() const -> void {
        G = nx.DiGraph();
        G.add_node("s", demand=-5);
        G.add_node("t", demand=5);
        G.add_edge("s", "a", weight=1, capacity=3);
    ...
    auto test_transshipment() const -> void {
        G = nx.DiGraph();
    ...
    auto test_max_flow_min_cost() const -> void {
        G = nx.DiGraph();
    ...
    auto test_zero_capacity_edges() const -> void {
    ...
    auto test_infinite_capacity_neg_digon() const -> void {
    ...
    auto test_finite_capacity_neg_digon() const -> void {
    ...
    auto test_negative_selfloops() const -> void {
    ...
    auto test_bone_shaped() const -> void {
        // From #1283
        G = nx.DiGraph();
