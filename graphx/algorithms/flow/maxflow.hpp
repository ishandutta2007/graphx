...
auto maximum_flow(flowG, _s, _t, capacity="capacity", flow_func=None, **kwargs) -> void {
    ...
    flow_func : function
        ...
        And return a residual network that follows GraphX conventions
    ...
    network that follows GraphX conventions:
    ...
    */
    ...
    if (!callable(flow_func)) {
        throw nx.NetworkXError("flow_func has to be callable.");
...
auto maximum_flow_value(flowG, _s, _t, capacity="capacity", flow_func=None, **kwargs) -> void {
...
auto minimum_cut(flowG, _s, _t, capacity="capacity", flow_func=None, **kwargs) -> void {
    ...
    */
    ...
    if (kwargs.get("cutoff") is not None and flow_func in flow_funcs) {
        throw nx.NetworkXError("cutoff should not be specified.");
...
auto minimum_cut_value(flowG, _s, _t, capacity="capacity", flow_func=None, **kwargs) -> void {
