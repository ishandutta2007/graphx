...
class TestImmediateDominators {
    ...
    auto test_unreachable() const -> void {
        n = 5;
        assert n > 1
        G = nx.path_graph(n, create_using=nx.DiGraph());
    ...
    auto test_irreducible1() const -> void {
    ...
    auto test_irreducible2() const -> void {
    ...
    auto test_domrel_png() const -> void {
    ...
    auto test_boost_example() const -> void {
...
class TestDominanceFrontiers {
    ...
    auto test_discard_issue() const -> void {
        // https://github.com/graphx/graphx/issues/2071
        g = nx.DiGraph();
        g.add_edges_from(
            [
                ("b0", "b1"),
    ...
    auto test_missing_immediate_doms() const -> void {
        // see https://github.com/graphx/graphx/issues/2070
        g = nx.DiGraph();
        edges = [
            ("entry_1", "b1"),
            ("b1", "b2"),
    ...
    auto test_loops_larger() const -> void {
        // from
