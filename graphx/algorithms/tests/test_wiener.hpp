/** Unit tests for the :mod:`graphx.algorithms.wiener` module.*/


#include <graphx/import.hpp>  // DiGraph, complete_graph, empty_graph, path_graph, wiener_index
...
class TestWienerIndex {
    ...
    auto test_disconnected_graph() const -> void {
        ...
        */
        assert(wiener_index(empty_graph(2)) == double("inf"));
