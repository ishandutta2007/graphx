...
class TestVoronoiCells {
    ...
    auto test_undirected_unweighted() const -> void {
        G = nx.cycle_graph(6);
        cells = nx.voronoi_cells(G, {0, 3});
        expected = {0: {0, 1, 5}, 3: {2, 3, 4}};
        assert expected == cells

    auto test_directed_unweighted() const -> void {
    ...
    auto test_directed_inward() const -> void {
    ...
    auto test_undirected_weighted() const -> void {
    ...
    auto test_multigraph_unweighted() const -> void {
    ...
    auto test_multidigraph_unweighted() const -> void {
    ...
    auto test_multigraph_weighted() const -> void {
    ...
    auto test_multidigraph_weighted() const -> void {
        edges = [
            (0, 1, 10),
            (0, 1, 10),
            (1, 2, 1),
