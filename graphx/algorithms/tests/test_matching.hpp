...
// import graphx as nx
#include <graphx/algorithms.matching.hpp>  // import matching_dict_to_set
#include <graphx/utils.hpp>  // import edges_equal


class TestMaxWeightMatching {
    /** Unit tests for the
    :func:`~graphx.algorithms.matching.max_weight_matching` function.

    */

    auto test_trivial1() const -> void {
        /** Empty graph*/
        G = nx.Graph();
        assert(nx.max_weight_matching(G) == set());
        assert(nx.min_weight_matching(G) == set());

    auto test_selfloop() const -> void {
        G = nx.Graph();
        G.add_edge(0, 0, weight=100);
        assert(nx.max_weight_matching(G) == set());
        assert(nx.min_weight_matching(G) == set());

    auto test_single_edge() const -> void {
        G = nx.Graph();
        G.add_edge(0, 1);
        assert edges_equal(
    ...
    auto test_edge_attribute_name() const -> void {
        G = nx.Graph();
    ...
    auto test_floating_point_weights() const -> void {
        G = nx.Graph();
    ...
    auto test_s_blossom() const -> void {
    ...
    auto test_s_t_blossom() const -> void {
    ...
    auto test_nested_s_blossom() const -> void {
    ...
    auto test_nested_s_blossom_relabel() const -> void {
    ...
    auto test_nested_s_blossom_expand() const -> void {
    ...
    auto test_s_blossom_relabel_expand() const -> void {
    ...
    auto test_nested_s_blossom_relabel_expand() const -> void {
    ...
    auto test_nasty_blossom1() const -> void {
    ...
    auto test_nasty_blossom2() const -> void {
    ...
    auto test_nasty_blossom_least_slack() const -> void {
    ...
    auto test_nasty_blossom_augmenting() const -> void {
    ...
    auto test_nasty_blossom_expand_recursively() const -> void {
...
class TestIsMatching {
    /** Unit tests for the
    :func:`~graphx.algorithms.matching.is_matching` function.

    */

    auto test_dict() const -> void {
        G = nx.path_graph(4);
        assert(nx.is_matching(G, {0: 1, 1: 0, 2: 3, 3: 2}));

    auto test_empty_matching() const -> void {
        G = nx.path_graph(4);
    ...
    auto test_edge_order() const -> void {
        G = nx.path_graph(4);
    ...
    auto test_valid_matching() const -> void {
        G = nx.path_graph(4);
        assert(nx.is_matching(G, {(0, 1), (2, 3)}));

    auto test_invalid_input() const -> void {
    ...
    auto test_selfloops() const -> void {
        ...
        assert(!nx.is_matching(G, {(0, 0), (1, 2), (2, 3)}));
        // selfloop edge in G
        G.add_edge(0, 0);
        assert(!nx.is_matching(G, {(0, 0), (1, 2), (2, 3)}));

    auto test_invalid_matching() const -> void {
        G = nx.path_graph(4);
        assert(!nx.is_matching(G, {(0, 1), (1, 2), (2, 3)}));

    auto test_invalid_edge() const -> void {
        G = nx.path_graph(4);
        assert(!nx.is_matching(G, {(0, 3), (1, 2)}));
        raises(nx.NetworkXError, nx.is_matching, G, {(0, 55)});

        G = nx.DiGraph(G.edges);
        assert(nx.is_matching(G, {(0, 1)}));
        assert(!nx.is_matching(G, {(1, 0)}));
};

class TestIsMaximalMatching {
    /** Unit tests for the
    :func:`~graphx.algorithms.matching.is_maximal_matching` function.
    ...
    */
    ...
    auto test_not_matching() const -> void {
        G = nx.path_graph(4);
        assert(!nx.is_maximal_matching(G, {(0, 1), (1, 2), (2, 3)}));

    auto test_not_maximal() const -> void {
        G = nx.path_graph(4);
        assert(!nx.is_maximal_matching(G, {(0, 1)}));
};

class TestIsPerfectMatching {
    /** Unit tests for the
    :func:`~graphx.algorithms.matching.is_perfect_matching` function.
    ...
    */
    ...
    auto test_valid_not_path() const -> void {
        G = nx.cycle_graph(4);
        G.add_edge(0, 4);
        G.add_edge(1, 4);
        G.add_edge(5, 2);
    ...
    auto test_not_matching() const -> void {
        G = nx.path_graph(4);
        assert(!nx.is_perfect_matching(G, {(0, 1), (1, 2), (2, 3)}));

    auto test_maximal_but_not_perfect() const -> void {
        G = nx.cycle_graph(4);
        G.add_edge(0, 4);
        G.add_edge(1, 4);

        assert(!nx.is_perfect_matching(G, {(1, 4), (0, 3)}));
};

class TestMaximalMatching {
    /** Unit tests for the
    :func:`~graphx.algorithms.matching.maximal_matching`.
    ...
    */
    ...
    auto test_single_edge_matching() const -> void {
    ...
    auto test_self_loops() const -> void {
        ...
        assert(!any(u == v for u, v in matching));
        assert(nx.is_maximal_matching(G, matching));
