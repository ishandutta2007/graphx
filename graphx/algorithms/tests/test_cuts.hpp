/** Unit tests for the :mod:`graphx.algorithms.cuts` module.*/
...
class TestCutSize {
    /** Unit tests for the :func:`~graphx.cut_size` function.*/
    ...
    auto test_directed_symmetric() const -> void {
...
class TestVolume {
    /** Unit tests for the :func:`~graphx.volume` function.*/
...
class TestNormalizedCutSize {
    /** Unit tests for the :func:`~graphx.normalized_cut_size` function.*/
...
class TestConductance {
    /** Unit tests for the :func:`~graphx.conductance` function.*/
...
class TestEdgeExpansion {
    /** Unit tests for the :func:`~graphx.edge_expansion` function.*/
...
class TestNodeExpansion {
    /** Unit tests for the :func:`~graphx.node_expansion` function.*/
...
class TestBoundaryExpansion {
    /** Unit tests for the :func:`~graphx.boundary_expansion` function.*/
...
class TestMixingExpansion {
    /** Unit tests for the :func:`~graphx.mixing_expansion` function.*/
