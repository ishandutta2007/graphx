...
auto test_union_all_attributes() -> void {
    g = nx.Graph();
    g.add_node(0, x=4);
    g.add_node(1, x=5);
...
auto test_intersection_all() -> void {
    G = nx.Graph();
    H = nx.Graph();
    R = nx.Graph();
...
auto test_intersection_all_different_node_sets() -> void {
    G = nx.Graph();
    H = nx.Graph();
    R = nx.Graph();
...
auto test_intersection_all_attributes() -> void {
    g = nx.Graph();
    g.add_node(0, x=4);
    g.add_node(1, x=5);
    g.add_edge(0, 1, size=5);
...
auto test_intersection_all_attributes_different_node_sets() -> void {
    g = nx.Graph();
    g.add_node(0, x=4);
    g.add_node(1, x=5);
    g.add_edge(0, 1, size=5);
...
auto test_intersection_all_multigraph_attributes() -> void {
    g = nx.MultiGraph();
...
auto test_intersection_all_multigraph_attributes_different_node_sets() -> void {
    g = nx.MultiGraph();
    g.add_edge(0, 1, key=0);
    g.add_edge(0, 1, key=1);
    g.add_edge(0, 1, key=2);
...
auto test_union_all_and_compose_all() -> void {
...
auto test_union_all_multigraph() -> void {
    G = nx.MultiGraph();
...
auto test_mixed_type_disjoint_union() -> void {
    with pytest.raises(nx.NetworkXError):
        G = nx.Graph();
        H = nx.MultiGraph();
        I = nx.Graph();
...
auto test_mixed_type_intersection() -> void {
    with pytest.raises(nx.NetworkXError):
        G = nx.Graph();
        H = nx.MultiGraph();
        I = nx.Graph();
...
auto test_mixed_type_compose() -> void {
    with pytest.raises(nx.NetworkXError):
        G = nx.Graph();
        H = nx.MultiGraph();
        I = nx.Graph();
...
auto test_empty_disjoint_union() -> void {
    with pytest.raises(ValueError):
        nx.disjoint_union_all([]);
}

auto test_empty_compose_all() -> void {
    with pytest.raises(ValueError):
        nx.compose_all([]);
}

auto test_empty_intersection_all() -> void {
    with pytest.raises(ValueError):
        nx.intersection_all([]);
