...
auto test_tensor_product_raises() -> void {
    with pytest.raises(nx.NetworkXError):
        P = nx.tensor_product(nx.DiGraph(), nx.Graph());
}

auto test_tensor_product_null() -> void {
    null = nx.null_graph();
...
auto test_tensor_product_size() -> void {
    P5 = nx.path_graph(5);
    K3 = nx.complete_graph(3);
...
auto test_tensor_product_combinations() -> void {
...
auto test_tensor_product_classic_result() -> void {
...
auto test_tensor_product_random() -> void {
...
auto test_cartesian_product_multigraph() -> void {
    G = nx.MultiGraph();
...
auto test_cartesian_product_raises() -> void {
    with pytest.raises(nx.NetworkXError):
        P = nx.cartesian_product(nx.DiGraph(), nx.Graph());
}

auto test_cartesian_product_null() -> void {
    null = nx.null_graph();
    empty10 = nx.empty_graph(10);
    K3 = nx.complete_graph(3);
    K10 = nx.complete_graph(10);
...
auto test_cartesian_product_size() -> void {
...
auto test_cartesian_product_classic() -> void {
...
auto test_cartesian_product_random() -> void {
    G = nx.erdos_renyi_graph(10, 2 / 10.0);
    H = nx.erdos_renyi_graph(10, 2 / 10.0);
    GH = nx.cartesian_product(G, H);
...
auto test_lexicographic_product_raises() -> void {
    with pytest.raises(nx.NetworkXError):
        P = nx.lexicographic_product(nx.DiGraph(), nx.Graph());
}

auto test_lexicographic_product_null() -> void {
    null = nx.null_graph();
    empty10 = nx.empty_graph(10);
    K3 = nx.complete_graph(3);
    K10 = nx.complete_graph(10);
...
auto test_lexicographic_product_size() -> void {
    K5 = nx.complete_graph(5);
    P5 = nx.path_graph(5);
    K3 = nx.complete_graph(3);
...
auto test_lexicographic_product_combinations() -> void {
    P5 = nx.path_graph(5);
    K3 = nx.complete_graph(3);
    G = nx.lexicographic_product(P5, K3);
    assert nx.number_of_nodes(G) == 5 * 3
...
auto test_lexicographic_product_random() -> void {
    G = nx.erdos_renyi_graph(10, 2 / 10.0);
    H = nx.erdos_renyi_graph(10, 2 / 10.0);
...
auto test_strong_product_raises() -> void {
    with pytest.raises(nx.NetworkXError):
        P = nx.strong_product(nx.DiGraph(), nx.Graph());
}

auto test_strong_product_null() -> void {
    null = nx.null_graph();
    empty10 = nx.empty_graph(10);
    K3 = nx.complete_graph(3);
    K10 = nx.complete_graph(10);
...
auto test_strong_product_size() -> void {
    K5 = nx.complete_graph(5);
    P5 = nx.path_graph(5);
    K3 = nx.complete_graph(3);
...
auto test_strong_product_combinations() -> void {
    P5 = nx.path_graph(5);
    K3 = nx.complete_graph(3);
    G = nx.strong_product(P5, K3);
    assert nx.number_of_nodes(G) == 5 * 3
...
auto test_strong_product_random() -> void {
    G = nx.erdos_renyi_graph(10, 2 / 10.0);
    H = nx.erdos_renyi_graph(10, 2 / 10.0);
...
auto test_graph_power_raises() -> void {
    with pytest.raises(nx.NetworkXNotImplemented):
        nx.power(nx.MultiDiGraph(), 2);
}

auto test_graph_power() -> void {
...
auto test_graph_power_negative() -> void {
    with pytest.raises(ValueError):
        nx.power(nx.Graph(), -1);
}

auto test_rooted_product_raises() -> void {
    with pytest.raises(nx.NetworkXError):
        nx.rooted_product(nx.Graph(), nx.path_graph(2), 10);
}

auto test_rooted_product() -> void {
    G = nx.cycle_graph(5);
    H = nx.Graph();
    H.add_edges_from([("a", "b"), ("b", "c"), ("b", "d")]);
    R = nx.rooted_product(G, H, "a");
    assert(R.size() == G.size() * H.size());
    assert(R.size() == G.size() + G.size() * H.size());
}

auto test_corona_product() -> void {
    G = nx.cycle_graph(3);
    H = nx.path_graph(2);
    C = nx.corona_product(G, H);
    assert(C.size() == (G.size() * H.size()) + G.size());
    assert(C.size() == G.size() + G.size() * H.size() + G.size() * H.size());
