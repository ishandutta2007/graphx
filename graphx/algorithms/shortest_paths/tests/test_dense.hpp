...
class TestFloyd {
    ...
    auto test_floyd_warshall_predecessor_and_distance() const -> void {
        XG = nx.DiGraph();
    ...
    auto test_reconstruct_path() const -> void {
    ...
    auto test_weighted2() const -> void {
        XG4 = nx.Graph();
    ...
    auto test_weight_parameter() const -> void {
        XG4 = nx.Graph();
        XG4.add_edges_from(
            [
                (0, 1, {"heavy": 2}),
    ...
    auto test_zero_distance() const -> void {
        XG = nx.DiGraph();
        XG.add_weighted_edges_from(
            [
                ("s", "u", 10),
    ...
    auto test_zero_weight() const -> void {
        G = nx.DiGraph();
