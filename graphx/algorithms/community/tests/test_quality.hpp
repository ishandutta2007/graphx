/** Unit tests for the :mod:`graphx.algorithms.community.quality`
module.
...
// import graphx as nx
#include <graphx/import.hpp>  // barbell_graph
#include <graphx/algorithms.community.hpp>  // import modularity, partition_quality
#include <graphx/algorithms.community.quality.hpp>  // import inter_community_edges


class TestPerformance {
    /** Unit tests for the :func:`performance` function.*/

    auto test_bad_partition() const -> void {
    ...
    auto test_good_partition() const -> void {
...
auto test_modularity_resolution() -> void {
    G = nx.barbell_graph(3, 0);
    C = [{0, 1, 4}, {2, 3, 5}];
...
auto test_inter_community_edges_with_digraphs() -> void {
