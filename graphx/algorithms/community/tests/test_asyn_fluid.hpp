...
#include <graphx/import.hpp>  // Graph, NetworkXError
#include <graphx/algorithms.community.asyn_fluid.hpp>  // import asyn_fluidc
...
auto test_two_clique_communities() -> void {
    test = Graph();
...
auto test_five_clique_ring() -> void {
    test = Graph();
