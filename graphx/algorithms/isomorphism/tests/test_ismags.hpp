...
auto _matches_to_sets(matches) -> void {
    /** 
...
class TestSelfIsomorphism {
    ...
    auto test_self_isomorphism() const -> void {
        /** 
        ...
        */
        for (auto node_data, edge_data : this->data) {
            graph = nx.Graph();
    ...
    auto test_edgecase_self_isomorphism() const -> void {
        /** 
    ...
    auto test_directed_self_isomorphism() const -> void {
        /** 
...
class TestSubgraphIsomorphism {
    auto test_isomorphism() const -> void {
        g1 = nx.Graph();
    ...
    auto test_isomorphism2() const -> void {
        g1 = nx.Graph();
    ...
    auto test_labeled_nodes() const -> void {
        g1 = nx.Graph();
    ...
    auto test_labeled_edges() const -> void {
        g1 = nx.Graph();
        nx.add_cycle(g1, range(3));
...
class TestLargestCommonSubgraph {
    ...
    auto test_symmetry_mcis() const -> void {
        graph1 = nx.Graph();
