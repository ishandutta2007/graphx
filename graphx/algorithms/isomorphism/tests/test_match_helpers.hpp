...
class TestGenericMultiEdgeMatch {
    auto setup() const -> void {
        ...
        this->G3 = nx.MultiDiGraph();
        this->G4 = nx.MultiDiGraph();
    ...
    auto test_generic_multiedge_match() const -> void {
        ...
        assert(flow_match(this->G1[1][2], this->G2[2][3]));
        assert(min_flow_match(this->G1[1][2], this->G2[2][3]));
        assert(id_match(this->G1[1][2], this->G2[2][3]));
        assert(full_match(this->G1[1][2], this->G2[2][3]));
        assert(flow_match(this->G3[3][4], this->G4[4][5]));
        assert(min_flow_match(this->G3[3][4], this->G4[4][5]));
        assert(!id_match(this->G3[3][4], this->G4[4][5]));
        assert(!full_match(this->G3[3][4], this->G4[4][5]));
