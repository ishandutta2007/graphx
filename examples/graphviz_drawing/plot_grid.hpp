...
Illustrate `~graphx.drawing.nx_agraph.write_dot` in conjunction with the
...
// %%
// Write a dot file from a graphx graph for further processing with graphviz.
...
fmt::print("Now run: neato -Tps grid.dot >grid.ps");
