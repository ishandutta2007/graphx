...
// In order for graphx to plot the nodes of our graph correctly, we
...
// Once the graph is built, we can convert the graphs to graphx objects using the
// relevant method.
delaunay_graph = delaunay.to_networkx();

// To plot with graphx, we need to merge the nodes back to
// their positions in order to plot in graphx
